export default async function AccountingPage({ params }: { params: Promise<{ tenant: string }> }) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      <h2 className="text-2xl font-bold mb-4">Accounting & Finance</h2>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="py-3 font-semibold text-gray-600">Account</th>
              <th className="py-3 font-semibold text-gray-600 text-right">Debit</th>
              <th className="py-3 font-semibold text-gray-600 text-right">Credit</th>
            </tr>
          </thead>
          <tbody>
