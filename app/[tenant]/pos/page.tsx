  ...
  return (
    <div className="flex h-full gap-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          {[1, 2, 3, 4, 5, 6].map((i) => (
            <div key={i} className="border border-gray-200 rounded p-4 text-center hover:bg-gray-50 cursor-pointer">
              ...
              <h4 className="font-medium">Menu Kopi {i}</h4>
      ...
      <div className="w-96 bg-white p-6 rounded-lg shadow-sm border border-gray-200 flex flex-col">
        <h3 className="text-xl font-bold mb-4">Pesanan Saat Ini</h3>
        ...
        <div className="border-t border-gray-200 pt-4">
          ...
          <button className="w-full bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700">Bayar</button>
        </div>
      </div>
    </div>
  );
