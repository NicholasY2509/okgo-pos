export default async function AdminAccountingPage() {
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      <h2 className="text-2xl font-bold mb-4">Akuntansi & Keuangan (Admin)</h2>
      <p className="text-gray-600 mb-8">Cabang: <span className="capitalize font-semibold">Semua Cabang</span></p>
